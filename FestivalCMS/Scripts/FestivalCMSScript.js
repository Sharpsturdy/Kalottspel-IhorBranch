$(document).ready(function () {
    $.ajax({
        url: $("#articlesmenu").attr("data-url"),
        dataType: "html",
        cache: false,
        success: function (data) {
            $("#articlesmenu").html(data);
        }
    });

});
//article list initiating
function InitiateArticlesList(showmenu) {
    if (showmenu === "True") {
        $("#contentmenu").addClass("in");
        $("#articlesmenu").addClass("in");
    }
    ...
    $("#page-wrapper").on("click", ".editart", function () {
        $.ajax({
            url: $(this).attr("data-url"),
            dataType: "html",
            cache: false,
    ...
    $("#page-wrapper").on("click", ".delart", function () {
    ...
    $("#page-wrapper").on("click", ".activeart", function () {
...
// Reinitiate validtation rules for forms wich loaded with Ajax
...
function InitiateArtistsList() {
    $("#programmenu").addClass("in");
    $("#page-wrapper").on("click", "#createarst", function () {
        $.ajax({
            url: $(this).attr("data-url"),
            dataType: "html",
            cache: false,
...
function InitiateArtistsInFestival() {
    $("#festivalsmenu").addClass("in");
    $("#page-wrapper").on("click", "#createarstinfest", function () {
        window.location.href = $(this).attr("data-url");
    });
    InitiateList();
}

function InitiateEventsList() {
    $("#programmenu").addClass("in");
    $("#page-wrapper").on("click", "#createevnt", function () {
        $.ajax({
            url: $(this).attr("data-url"),
            dataType: "html",
            cache: false,
...
function InitiateFestivalsList() {
    $("#page-wrapper").on("click", "#createfest", function () {
        window.location.href = $(this).attr("data-url");
    });
    $("#page-wrapper").on("click", ".festlink", function () {
        window.location.href = $(this).attr("data-url")
    });
    InitiateList();
}

function InitiateEventsInFestivalList() {
    $("#festivalsmenu").addClass("in");
    $("#page-wrapper").on("click", "#createfestevent", function () {
        $.ajax({
            url: $(this).attr("data-url"),
            dataType: "html",
            cache: false,
...
function InitiateSeminarList() {
    $("#page-wrapper").on("click", "#createsem", function () {
        window.location.href = $(this).attr("data-url");
    });
    InitiateList();
}
